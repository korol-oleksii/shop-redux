  ...
  return(
      <div className="CartProduct card">
          ...
          <div className="card__action mesh--row">
              ...
              <div className="card__action--to-cart">
                  <Link className="button" to="/shoppingCart">
                      <img src={buySvg} alt="cart"/>
                      Go to Cart
                  </Link>
              </div>
          </div>
